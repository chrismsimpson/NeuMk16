...
namespace Core {
    ...
    template<typename Destination, typename Source, bool distinationIsWider = (sizeof(Destination) >= sizeof(Source)), bool destinationIsSigned = NumericLimits<Destination>::isSigned(), bool sourceIsSigned = NumericLimits<Source>::isSigned()>
    ...
    template<typename Destination, typename Source>
    [[nodiscard]] constexpr bool isWithinRange(
        Source value) {
