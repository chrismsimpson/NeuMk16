...
#ifdef __i386__
#    define CORE_ARCH_I386 1
#endif

#ifdef __x86_64__
#    define CORE_ARCH_X86_64 1
#endif

#ifdef __aarch64__
#    define CORE_ARCH_AARCH64 1
#endif

#if defined(__APPLE__) && defined(__MACH__)
#    define CORE_OS_MACOS
#    define CORE_OS_BSD_GENERIC
#endif
...
#define ARCH(arch) (defined(CORE_ARCH_##arch) && CORE_ARCH_##arch)
...
#    define CORE_HAS_CONDITIONALLY_TRIVIAL
#endif
